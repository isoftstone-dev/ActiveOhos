...
import com.activeharmony.annotation.Column.ConflictAction;
...
//	public static final boolean FOREIGN_KEYS_SUPPORTED = Build.VERSION.SDK_INT >= Build.VERSION_CODES.FROYO;
    ...
    public static void execSql(String sql) {
        Cache.openDatabase().executeSql(sql);
    }

    public static void execSql(String sql, Object[] bindArgs) {
        Cache.openDatabase().executeSql(sql, bindArgs);
    }

    public static <T extends Model> List<T> rawQuery(Class<? extends Model> type, String sql, String[] selectionArgs) {
        ResultSet cursor = Cache.openDatabase().querySql(sql, selectionArgs);
    ...
    public static int intQuery(final String sql, final String[] selectionArgs) {
        final ResultSet cursor = Cache.openDatabase().querySql(sql, selectionArgs);
...
//        return "CREATE TABLE IF NOT EXISTS user (Id INTEGER PRIMARY KEY AUTOINCREMENT, addr TEXT, age INTEGER, userId INTEGER, userName TEXT);";
    }
